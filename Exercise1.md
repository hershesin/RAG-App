...
## Overview
In this module, you will set up the foundational Azure resources required to build the RAG application. You will create a resource group, deploy Azure OpenAI Service, and set up Azure AI Search. You will also deploy the required models, including a GPT model for generating responses and an embedding model for performing vector-based search. Additionally, you will collect the necessary keys and endpoints that will be used to connect these services in later modules.
...
1. On the Basics tab of Create Azure OpenAI resource page, enter the following details:
    ...
    - Resource group: **Select Openai-embedded- (2)**
    - Region: **Select (3)**.
    - Name: **openai- (4)**
